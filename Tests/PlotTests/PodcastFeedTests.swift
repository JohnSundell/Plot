...
extension PodcastFeedTests {
    static var allTests: Linux.TestList<PodcastFeedTests> {
        [
            ("testEmptyFeed", testEmptyFeed),
            ("testNewFeedURL", testNewFeedURL),
            ("testPodcastTitle", testPodcastTitle),
            ("testPodcastSubtitle", testPodcastSubtitle),
            ("testPodcastDescription", testPodcastDescription),
            ("testPodcastSummary", testPodcastSummary),
            ("testPodcastURL", testPodcastURL),
            ("testPodcastAtomLink", testPodcastAtomLink),
            ("testPodcastLanguage", testPodcastLanguage),
            ("testPodcastTTL", testPodcastTTL),
            ("testPodcastCopyright", testPodcastCopyright),
            ("testPodcastAuthor", testPodcastAuthor),
            ("testPodcastExplicitFlag", testPodcastExplicitFlag),
            ("testPodcastOwner", testPodcastOwner),
            ("testPodcastCategory", testPodcastCategory),
            ("testPodcastSubcategory", testPodcastSubcategory),
            ("testPodcastType", testPodcastType),
            ("testPodcastImage", testPodcastImage),
            ("testPodcastPublicationDate", testPodcastPublicationDate),
            ("testPodcastLastBuildDate", testPodcastLastBuildDate),
            ("testEpisodeGUID", testEpisodeGUID),
            ("testEpisodeTitle", testEpisodeTitle),
            ("testEpisodeDescription", testEpisodeDescription),
            ("testEpisodeURL", testEpisodeURL),
            ("testEpisodePublicationDate", testEpisodePublicationDate),
            ("testEpisodeDuration", testEpisodeDuration),
            ("testSeasonNumber", testSeasonNumber),
            ("testEpisodeNumber", testEpisodeNumber),
            ("testEpisodeType", testEpisodeType),
            ("testEpisodeAudio", testEpisodeAudio),
            ("testEpisodeHTMLContent", testEpisodeHTMLContent)
        ]
    }
}
